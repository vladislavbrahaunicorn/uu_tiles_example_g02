...
const Errors = require("../api/errors/tiles-example-error.js");
...
const logger = LoggerFactory.get("TilesExampleAbl");

class TilesExampleAbl {
  constructor() {
...
module.exports = new TilesExampleAbl();
