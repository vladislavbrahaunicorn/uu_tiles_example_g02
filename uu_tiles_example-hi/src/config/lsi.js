const Lsi = {
  ...
  about: {
    header: {
      cs: "O aplikaci uuTiles",
      en: "About application uuTiles",
    },
    creatorsHeader: {
      cs: "Tvůrci aplikace",
  ...
  unauthInit: {
    buyYourOwn: {
      cs: "Můžete si koupit vlastní uuTiles.",
      en: "You can buy your own uuTiles.",
    },
    notAuthorized: {
      cs: "Nemáte právo inicializovat tuto aplikaci uuTiles.",
      en: "You don't have rights to initialize this uuTiles.",
    },
  },
